...
let favoriteNumber = 18; //This save your favorite number
...
let names = ["Yaqoob_Qadir", "Usama_Ashraf", "Arif_Bashir"];
...
let guests = ["Muhammad_Ahmed", "Hassaan_Farid", "Usama_Ashraf"];
...
let Favrit_Place = ["Lahore", "karachi", "metti", "islamkot"];
...
let Guests = ["Usama_Ashraf", "Ahmed_Ali", "Arif_BAloch", "Muhammad_Ahmed", "Yaqoob_Qadir", "Faisal_Qadir"];
...
let cities = ["Lahore", "Isalamabad", "Quetta", "Murree"];
...
let friends = ["Usman_Rehman", "jumshid_Ali", "Salman_Ahmed"];
...
// Test whether an item is in a array
let fruits = ["Apple", "Mango", "Orange", "Water_Melan"];
...
let favorite_fruits = ["mengo", "banana", "orange", "water_melon", "cherries"];
...
let current_users = ["yaqoob qadir", "faisal qadir", "sohail ahmed", "jameel", "shaqoor"];
let new_users = ["nabi ayoub", "yaqoob qadir", "faisal qadir", "usama ashraf", "naseer ahmed"];
...
let favorite_Pizzas = ["BBQ blast", "Pepperoni", "Mergherita"];
...
let Magicians = ["hamaad ali", "mushtak", "ali hamza"];
